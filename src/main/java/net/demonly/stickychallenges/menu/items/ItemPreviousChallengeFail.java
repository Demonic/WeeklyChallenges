...
public class ItemPreviousChallengeFail {

    public static ItemStack get(StickyChallengesPlugin plugin) {
        ItemStack itemStack = new ItemStack(Material.valueOf(plugin.getLang().getString("item_previous_challenge.fail.material")));
        ...
        meta.setLore(plugin.getLang().getStringList("item_previous_challenge.fail.lore")
                .stream()
        ...
        meta.setDisplayName(Util.translate(plugin.getLang().getString("item_previous_challenge.fail.name")));
